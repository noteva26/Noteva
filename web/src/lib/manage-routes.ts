export const managePageLoaders = {
  ...
  taxonomy: () => import("@/pages/manage/taxonomy"),
  categories: () => import("@/pages/manage/categories"),
  tags: () => import("@/pages/manage/tags"),
  pages: () => import("@/pages/manage/pages"),
  about: () => import("@/pages/manage/about"),
  friendLinks: () => import("@/pages/manage/friend-links"),
  nav: () => import("@/pages/manage/nav"),
  comments: () => import("@/pages/manage/comments"),
  commentSettings: () => import("@/pages/manage/comments/settings"),
...
const manageRoutePreloaders: Record<string, () => Promise<unknown>> = {
  ...
  "/manage/taxonomy": managePageLoaders.taxonomy,
  "/manage/categories": managePageLoaders.taxonomy,
  "/manage/tags": managePageLoaders.taxonomy,
  "/manage/pages": managePageLoaders.pages,
  "/manage/about": managePageLoaders.about,
  "/manage/friend-links": managePageLoaders.friendLinks,
  "/manage/nav": managePageLoaders.nav,
  "/manage/comments": managePageLoaders.comments,
  "/manage/comments/settings": managePageLoaders.commentSettings,
