...
pub struct Page {
    ...
    /// Origin of this page: "user" (manually created), "plugin:<id>", or "theme:<short>"
...
impl Page {
    ...
    /// Create a page auto-generated by a plugin or theme
    pub fn new_auto(slug: String, title: String, source: String) -> Self {
        let now = Utc::now();
        Self {
            id: 0,
            slug,
