...
pub(super) async fn create_article_mysql(
    pool: &MySqlPool,
...
pub(super) async fn get_article_by_slug_mysql(
    pool: &MySqlPool,
    slug: &str,
...
pub(super) async fn list_articles_mysql(
    pool: &MySqlPool,
    offset: i64,
    limit: i64,
...
pub(super) async fn update_article_mysql(
    pool: &MySqlPool,
    id: i64,
...
pub(super) async fn list_articles_by_category_mysql(
    pool: &MySqlPool,
    category_id: i64,
    offset: i64,
    limit: i64,
...
pub(super) async fn list_articles_by_tag_mysql(
    pool: &MySqlPool,
    tag_id: i64,
    offset: i64,
    limit: i64,
...
pub(super) async fn list_published_articles_mysql(
    pool: &MySqlPool,
    offset: i64,
    limit: i64,
    sort_by: ArticleSortBy,
...
pub(super) async fn search_articles_mysql(
    pool: &MySqlPool,
    keyword: &str,
    offset: i64,
    limit: i64,
